...
<!ELEMENT Video EMPTY>
<!ATTLIST Video codec (h264|h263|m4v|hevc) #REQUIRED>
<!ATTLIST Video bitRate CDATA #REQUIRED>
<!ATTLIST Video width CDATA #REQUIRED>
<!ATTLIST Video height CDATA #REQUIRED>
<!ATTLIST Video frameRate CDATA #REQUIRED>
<!ELEMENT Audio EMPTY>
<!ATTLIST Audio codec (amrnb|amrwb|aac|heaac) #REQUIRED>
...
<!ATTLIST AudioEncoderCap name (amrnb|amrwb|aac|wma|heaac) #REQUIRED>
...
<!ATTLIST ExportVideoProfile name (h264|h263|m4v|hevc) #REQUIRED>
...
<MediaSettings>
    ...
    <VideoEncoderCap name="h264" enabled="true"
        minBitRate="64000" maxBitRate="55000000"
    ...
    <VideoEncoderCap name="hevc" enabled="true"
        ...
        minFrameHeight="144" maxFrameHeight="2176"
    ...
    -->
    <ExportVideoProfile name="h264" profile= "2" level="2048"/>
    <!--
	...
	<!--
      Codec = hevc, Baseline profile, level 4.0
    -->
    <ExportVideoProfile name="hevc" profile= "2" level="2048"/>
</MediaSettings>
