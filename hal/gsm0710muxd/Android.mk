...
LOCAL_CFLAGS += -DMTK_RIL_MD1 -DMTK_ENABLE_MD1

LOCAL_C_INCLUDES := $(DEVICE_PATH)/hal/ccci/include
...
MTK_SHARE_MODEM_SUPPORT := $(SIM_COUNT)
...
LOCAL_CFLAGS += -DMTK_RIL_MD2 -DMTK_ENABLE_MD2
