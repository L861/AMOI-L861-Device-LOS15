...
#define POWER_DT2W_ENABLED                "/proc/gt9xx_gesture"
...
#define __cpu_cluster_write(core, var)  Utils::writeCpuGov(core, #var, data->cpu.var)
#define cpu_write(var)  __cpu_cluster_write(0, var)

// double-argument macro, var != filename
#define __cpu_cluster_write2(core, var, file)  Utils::writeCpuGov(core, file, data->cpu.var)
#define cpu_write2(var, file)  __cpu_cluster_write2(0, var, file)

/*
 * Write cpugov-specific settings
 */
// single-argument macro, var == filename
#define __cpugov_cluster_write(cpugov, core, var)  Utils::writeCpuGov(core, #var, data->cpu.cpugov.var)
#define cpugov_write(cpugov, var)  __cpugov_cluster_write(cpugov, 0, var)


// double-argument macro, var != filename
#define __cpugov_cluster_write2(cpugov, core, var, file)  Utils::writeCpuGov(core, file, data->cpu.cpugov.var)
#define cpugov_write2(cpugov, var, file)  __cpugov_cluster_write2(cpugov, 0, var, file)
...
#define if_cpugov(gov)  __if_cluster_cpugov(0, gov)
...
private:
	...
	// profile Latest in use. may be set by every power-method.
	// Default to <INVALID>.
	SecPowerProfiles mLatestProfile;
