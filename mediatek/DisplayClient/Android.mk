...
#-----------------------------------------------------------
#sinclude $(TOP)/$(LOCAL_PATH)/../hardware/mtkcam/mtkcam.mk
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../hardware/include
#
# LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/frameworks-ext/av/include
#
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../hardware/gralloc_extra/include
#
