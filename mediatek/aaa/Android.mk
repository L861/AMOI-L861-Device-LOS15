...
MTK_PATH_COMMON := $(TOP)/$(DEVICE_PATH)/mediatek
MTK_PATH_CUSTOM := $(TOP)/$(DEVICE_PATH)/mediatek
MTK_PATH_CUSTOM_PLATFORM := $(TOP)/$(DEVICE_PATH)/mediatek

MTK_PATH_SOURCE := $(DEVICE_PATH)/mediatek
MTK_PATH_PLATFORM := $(DEVICE_PATH)/mediatek
...
LOCAL_C_INCLUDES := \
    ...
    $(MTK_PATH_PLATFORM)/hardware/mtkcam/D1/core/featureio/drv/inc \
    $(MTK_PATH_PLATFORM)/hardware/mtkcam/D1/core/featureio/drv/cam_cal \
    ...
    $(MTK_PATH_PLATFORM)/hardware/mtkcam/D1/core/featureio/pipe/aaa/buf_mgr \
    ...
    $(MTK_PATH_PLATFORM)/hardware/mtkcam/D1/core/featureio/pipe/aaa/isp_tuning/paramctrl/inc \
    $(MTK_PATH_PLATFORM)/hardware/mtkcam/D1/core/featureio/pipe/aaa/isp_tuning/paramctrl/pca_mgr/ \
    $(MTK_PATH_PLATFORM)/hardware/mtkcam/D1/core/featureio/pipe/aaa/isp_tuning/paramctrl/ccm_mgr/ \
    ...
    $(MTK_PATH_PLATFORM)/hardware/mtkcam/D1/core/featureio/pipe/aaa/ResultBufMgr \
    ...
    $(MTK_PATH_PLATFORM)/hardware/include/D1/mtkcam/algorithm/libsync3a \
    $(TOP)/$(MTK_PATH_PLATFORM)/hardware \
    $(MTK_PATH_PLATFORM)/hardware/include \
    $(MTK_PATH_PLATFORM)/hardware/mtkcam/D1/core/drv/imgsensor \
    $(MTK_PATH_PLATFORM)/hardware/mtkcam/D1/core/imageio/inc
...
LOCAL_C_INCLUDES += \
    ...
    $(TOP)/$(MTK_PATH_PLATFORM)/hardware/include/D1/mtkcam/algorithm/libcore \
    $(TOP)/$(MTK_PATH_PLATFORM)/hardware/include/D1/mtkcam/algorithm/libwarp \
    $(TOP)/$(MTK_PATH_PLATFORM)/hardware/include/D1/mtkcam/algorithm/libutility \
    $(TOP)/$(MTK_PATH_PLATFORM)/hardware/include/D1/mtkcam/algorithm/libstereocam \
    $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/D1/core/featureio/pipe/stereo
#LOCAL_C_INCLUDES += \
