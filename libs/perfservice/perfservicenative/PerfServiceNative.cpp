...
static sp<IBinder> pbinder = NULL;
...
static void init(void)
{
    if(!inited) {
        ...
        pbinder = sm->checkService(String16("mtk-perfservice")); // use check to avoid null binder
        if(pbinder!=NULL) {
            inited = 1;
        }
    }
...
void PerfServiceNative_boostEnable(int scenario)
{
    ...
    if(pbinder!=NULL) {
        ...
        pbinder->transact(TRANSACTION_boostEnable ,data,&reply); // should sync with IPerfService
    }
}
...
void PerfServiceNative_boostDisable(int scenario)
{
    ...
    if(pbinder!=NULL) {
        data.writeInterfaceToken(String16("com.mediatek.perfservice.IPerfService"));
        data.writeInt32(scenario);
        pbinder->transact(TRANSACTION_boostDisable ,data,&reply);
    }
}
...
void PerfServiceNative_boostEnableTimeout(int scenario, int timeout)
{
    ...
    if(pbinder!=NULL) {
        ...
        pbinder->transact(TRANSACTION_boostEnableTimeout ,data,&reply);
    }
}
...
void PerfServiceNative_boostEnableTimeoutMs(int scenario, int timeout_ms)
{
    ...
    if(pbinder!=NULL) {
        ...
        pbinder->transact(TRANSACTION_boostEnableTimeoutMs ,data,&reply);
    }
}
...
void PerfServiceNative_boostEnableAsync(int scenario)
{
    ...
    if(pbinder!=NULL) {
        data.writeInterfaceToken(String16("com.mediatek.perfservice.IPerfService"));
        data.writeInt32(scenario);
        pbinder->transact(TRANSACTION_boostEnable ,data,&reply,IBinder::FLAG_ONEWAY); // should sync with IPerfService
    }
}
...
void PerfServiceNative_boostDisableAsync(int scenario)
{
    ...
    if(pbinder!=NULL) {
        data.writeInterfaceToken(String16("com.mediatek.perfservice.IPerfService"));
        data.writeInt32(scenario);
        pbinder->transact(TRANSACTION_boostDisable ,data,&reply,IBinder::FLAG_ONEWAY);
    }
}
...
void PerfServiceNative_boostEnableTimeoutAsync(int scenario, int timeout)
{
    ...
    if(pbinder!=NULL) {
        ...
        data.writeInt32(scenario);
        data.writeInt32(timeout);
        pbinder->transact(TRANSACTION_boostEnableTimeout ,data,&reply,IBinder::FLAG_ONEWAY);
    }
}
...
void PerfServiceNative_boostEnableTimeoutMsAsync(int scenario, int timeout_ms)
{
    ...
    if(pbinder!=NULL) {
        ...
        data.writeInt32(scenario);
        data.writeInt32(timeout_ms);
        pbinder->transact(TRANSACTION_boostEnableTimeoutMs ,data,&reply,IBinder::FLAG_ONEWAY);
    }
}
...
int PerfServiceNative_userReg(int scn_core, int scn_freq)
{
    ...
    if(pbinder!=NULL) {
        ...
        data.writeInt32(pid);
        data.writeInt32(tid);
        pbinder->transact(TRANSACTION_userReg ,data,&reply); // should sync with IPerfService
...
int PerfServiceNative_userRegBigLittle(int scn_core_big, int scn_freq_big, int scn_core_little, int scn_freq_little)
{
    ...
    if(pbinder!=NULL) {
        ...
        data.writeInt32(pid);
        data.writeInt32(tid);
        pbinder->transact(TRANSACTION_userRegBigLittle ,data,&reply); // should sync with IPerfService
        reply.readExceptionCode();
        handle = reply.readInt32();
    }
    return handle;
...
void PerfServiceNative_userUnreg(int handle)
{
    ...
    if(pbinder!=NULL) {
        ...
        pbinder->transact(TRANSACTION_userUnreg ,data,&reply); // should sync with IPerfService
    }
}
...
int PerfServiceNative_userGetCapability(int cmd)
{
    ...
    if(pbinder!=NULL) {
        data.writeInterfaceToken(String16("com.mediatek.perfservice.IPerfService"));
        data.writeInt32(cmd);
        pbinder->transact(TRANSACTION_userGetCapability ,data,&reply); // should sync with IPerfService
        reply.readExceptionCode();
...
int PerfServiceNative_userRegScn(void)
{
    ...
    if(pbinder!=NULL) {
        ...
        data.writeInt32(pid);
        data.writeInt32(tid);
        pbinder->transact(TRANSACTION_userRegScn ,data,&reply); // should sync with IPerfService
        reply.readExceptionCode();
        handle = reply.readInt32();
    }
    return handle;
...
void PerfServiceNative_userRegScnConfig(int handle, int cmd, int param_1, int param_2, int param_3, int param_4)
{
    ...
    if(pbinder!=NULL) {
        ...
        pbinder->transact(TRANSACTION_userRegScnConfig,data,&reply); // should sync with IPerfService
    }
}
...
void PerfServiceNative_userUnregScn(int handle)
{
    ...
    if(pbinder!=NULL) {
        data.writeInterfaceToken(String16("com.mediatek.perfservice.IPerfService"));
        data.writeInt32(handle);
        pbinder->transact(TRANSACTION_userUnregScn,data,&reply); // should sync with IPerfService
    }
}
...
void PerfServiceNative_userEnable(int handle)
{
    ...
    if(pbinder!=NULL) {
        data.writeInterfaceToken(String16("com.mediatek.perfservice.IPerfService"));
        data.writeInt32(handle);
        pbinder->transact(TRANSACTION_userEnable ,data,&reply); // should sync with IPerfService
    }
}
...
void PerfServiceNative_userDisable(int handle)
{
    ...
    if(pbinder!=NULL) {
        data.writeInterfaceToken(String16("com.mediatek.perfservice.IPerfService"));
        data.writeInt32(handle);
        pbinder->transact(TRANSACTION_userDisable ,data,&reply);
    }
}
...
void PerfServiceNative_userEnableTimeout(int handle, int timeout)
{
    ...
    if(pbinder!=NULL) {
        ...
        data.writeInt32(handle);
        data.writeInt32(timeout);
        pbinder->transact(TRANSACTION_userEnableTimeout ,data,&reply);
    }
}
...
void PerfServiceNative_userEnableTimeoutMs(int handle, int timeout_ms)
{
    ...
    if(pbinder!=NULL) {
        ...
        data.writeInt32(handle);
        data.writeInt32(timeout_ms);
        pbinder->transact(TRANSACTION_userEnableTimeoutMs ,data,&reply);
    }
}
...
void PerfServiceNative_userResetAll(void)
{
    ...
    if(pbinder!=NULL) {
        data.writeInterfaceToken(String16("com.mediatek.perfservice.IPerfService"));
        pbinder->transact(TRANSACTION_userResetAll ,data,&reply);
    }
}
...
void PerfServiceNative_userDisableAll(void)
{
    ...
    if(pbinder!=NULL) {
        data.writeInterfaceToken(String16("com.mediatek.perfservice.IPerfService"));
        pbinder->transact(TRANSACTION_userDisableAll ,data,&reply);
    }
}
...
void PerfServiceNative_dumpAll(void)
{
    ...
    if(pbinder!=NULL) {
        data.writeInterfaceToken(String16("com.mediatek.perfservice.IPerfService"));
        pbinder->transact(TRANSACTION_dumpAll ,data,&reply);
    }
}
...
void PerfServiceNative_setFavorPid(int pid)
{
    ...
    if(pbinder!=NULL) {
        data.writeInterfaceToken(String16("com.mediatek.perfservice.IPerfService"));
        data.writeInt32(pid);
        pbinder->transact(TRANSACTION_setFavorPid,data,&reply,IBinder::FLAG_ONEWAY);
    }
}
...
void PerfServiceNative_restoreBoostThread(void)
{
    ...
    if(pbinder!=NULL) {
        data.writeInterfaceToken(String16("com.mediatek.perfservice.IPerfService"));
        data.writeInt32(tid | RENDER_BIT);
        pbinder->transact(TRANSACTION_restorePolicy,data,&reply,IBinder::FLAG_ONEWAY);
    }
}
...
void PerfServiceNative_notifyFrameUpdate(int level)
{
    ...
    if(mPreviousTime == 0 || (now - mPreviousTime) > RENDER_THREAD_UPDATE_DURATION) { // 400ms
        ...
        if(pbinder!=NULL) {
            ...
            pbinder->transact(TRANSACTION_notifyFrameUpdate ,data,&reply,IBinder::FLAG_ONEWAY);
        }
        mPreviousTime = now;
    }
}
...
void PerfServiceNative_notifyDisplayType(int type)
{
    ...
    if(pbinder!=NULL) {
        ...
        pbinder->transact(TRANSACTION_notifyDisplayType ,data,&reply,IBinder::FLAG_ONEWAY);
    }
}
...
void PerfServiceNative_notifyUserStatus(int type, int status)
{
    ...
    if(pbinder!=NULL) {
        ...
        pbinder->transact(TRANSACTION_notifyUserStatus ,data,&reply,IBinder::FLAG_ONEWAY);
    }
}
...
const char* PerfServiceNative_getPackName()
{
    ...
    if(pbinder!=NULL) {
        data.writeInterfaceToken(String16("com.mediatek.perfservice.IPerfService"));
        pbinder->transact(TRANSACTION_getPackName,data,&reply);
        reply.readExceptionCode();
    ...
    return "error libperfservicenative\n";
}
...
int PerfServiceNative_getLastBoostPid()
{
    ...
    if(pbinder!=NULL) {
        data.writeInterfaceToken(String16("com.mediatek.perfservice.IPerfService"));
        pbinder->transact(TRANSACTION_getLastBoostPid,data,&reply);
        reply.readExceptionCode();
