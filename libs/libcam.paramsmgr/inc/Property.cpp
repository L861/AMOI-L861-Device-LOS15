...
#define LOG_TAG "MtkCam/Utils/Property"
//
#include "MyUtils.h"
#include <string>
...
{
	std::string str1 (key.string());
	std::string str2 ("MTK_STEREO_FEATURE_SUPPORT");
	String8 value2 = String8("false");
	if (str1.compare(str2) != 0) {
		RWLock::AutoWLock _l(gRWLock);
		gPropertyMap.addProperty(key, value2);
		MY_LOGD("pid/tid=%d/%d (%s)=(%s)", ::getpid(), ::gettid(), key.string(), value2.string());
	}else{
		RWLock::AutoWLock _l(gRWLock);
