...
struct SensorDynamicInfo{
	...
	MUINT pixelMode;    /*ONE_PIXEL_MODE, TWO_PIXEL_MODE, FOUR_PIXEL_,MODE*/
	MUINT TgVR1Info;    /* CAM_TG_1, CAM_TG_2, CAM_TG_3, CAM_TG_4, CAM_TG_5, CAM_TG_6*/
	MUINT TgVR2Info;
	MUINT TgCLKInfo;    /*Unit : Khz*/
	MUINT HDRInfo;
	MUINT PDAFInfo;
	MUINT HDRPixelMode; /*ONE_PIXEL_MODE, TWO_PIXEL_MODE, FOUR_PIXEL_,MODE*/
	MUINT PDAFPixelMode;
};
