...
public:     ////                        Attributes.
    ...
    virtual bool                        setForceHalAppMode(String8 const& mode);
    virtual bool                        evaluateHalAppMode(String8 &mode) const;
...
public:     ////                        Operations.
    ...
    virtual void                        updatePreviewAEIndexShutterGain(int const index, int const shutter, int const isp_gain, int const sensor_gain, int const iso);
...
protected:  ////                        Update Params based on FeatureInfo
    ...
    bool                                updateDNGParams(NSCameraFeature::FeatureInfo const& rFeatureInfo);
    bool                                evaluateHalAppModeUtility(String8& mode) const;
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
protected:  ////                        For Display Rotation
    bool                                getDisplayRotationSupported() const;
    void                                setDisplayRotationSupported(bool isSupport);
    void                                getPanelSize(int *width, int *height) const;
    void                                AddPreviewSizeForPanel();
