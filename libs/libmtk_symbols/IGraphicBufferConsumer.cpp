...
#include <inc/IConsumerListener.h>
#include <inc/IGraphicBufferConsumer.h>
...
public:
    ...
    virtual status_t consumerConnect(const sp<IConsumerListener>& consumer, bool controlledByApp) {
        ...
        data.writeStrongBinder(consumer->asBinder(NULL));
		//data.writeStrongBinder(IInterface::asBinder(NULL));
