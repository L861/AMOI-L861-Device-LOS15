 ...
 *
 ******************************************************************************/
#define MY_LOGV(fmt, arg...)        ALOGV("(%s)[%s] " fmt, getMagicName(), __FUNCTION__, ##arg)
#define MY_LOGD(fmt, arg...)        ALOGD("(%s)[%s] " fmt, getMagicName(), __FUNCTION__, ##arg)
#define MY_LOGI(fmt, arg...)        ALOGI("(%s)[%s] " fmt, getMagicName(), __FUNCTION__, ##arg)
#define MY_LOGW(fmt, arg...)        ALOGW("(%s)[%s] " fmt, getMagicName(), __FUNCTION__, ##arg)
#define MY_LOGE(fmt, arg...)        ALOGE("(%s)[%s] " fmt, getMagicName(), __FUNCTION__, ##arg)
#define MY_LOGA(fmt, arg...)        ALOGI("(%s)[%s] " fmt, getMagicName(), __FUNCTION__, ##arg)
#define MY_LOGF(fmt, arg...)        ALOGE("(%s)[%s] " fmt, getMagicName(), __FUNCTION__, ##arg)
//
...
getHeapID(size_t index) const
{
    ...
    //
    /*if (index == 0){
		MY_LOGD("Index 0 Size %zu",rvHeapInfo.size());
		return 0;
	} */
